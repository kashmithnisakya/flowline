...
if(/^\/(login|auth\/callback)?$/.test(location.pathname)||!g('jac_token'))return;
var s=dark?'#191D1B':'#FFFFFF',l=dark?'#2D3330':'#D3D8D2',k=dark?'#1E2220':'#DEDFDD';
var c='#flowline-boot i{display:block;background:'+k+';border-radius:4px}'
...
+'.bk{width:50px;height:12px;margin:0 12px}.bu,.bo,.bd,.bs{display:none}'
+'.bp{padding:24px 16px}.bt{width:104px;height:24px;margin:6px 0 24px}.bl{height:14px;margin-bottom:14px}'
+'@media(max-width:639px){.bn,.bq,.bk{display:none}.bu{display:block;width:80px;height:14px}}'
+'@media(min-width:640px){.bp{padding:24px}}'
+'@media(min-width:1024px){.bh{padding:0 20px}.bo,.bd,.bs{display:block}.bp{padding:32px 40px}}';
function n(x,y){return '<i class="bn '+(y||'')+'" style="width:'+x+'px"></i>'}
var e=d.createElement('div');e.id='flowline-boot';
e.innerHTML='<style>'+c+'</style><div class="bh"><i class="bm"></i><i class="bo"></i><i class="bu"></i>'
+n(36)+n(34)+n(57)+n(20)+n(55)+'<i class="bd"></i>'+n(51,'bs')+n(63,'bs')+n(40,'bs')
+'<div class="br"><i class="bq"></i><i class="bk"></i><i class="ba"></i></div></div>'
+'<div class="bp"><i class="bt"></i><i class="bl" style="width:42%"></i><i class="bl" style="width:58%"></i><i class="bl" style="width:36%"></i></div>';
function f(){var r=d.getElementById('root');if(r)r.parentNode.insertBefore(e,r)}
d.readyState=='loading'?d.addEventListener('readystatechange',f):f();
})();
